...
class Deck:
    ...
    def _initialize_deck(self):
        ...
        for _ in range(2):
            self.cards.append(Card("Stock", CardColor.GREEN, "Place in front of a player; they skip their next turn."))
        for _ in range(2):
            self.cards.append(Card("Arson", CardColor.GREEN, "Discard all blue cards in front of a player."))
