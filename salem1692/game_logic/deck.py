...
class Deck:
    ...
    def _initialize_deck(self):
        ...
        # Red cards
        for _ in range(18):
            self.cards.append(Card("Accusation", CardColor.RED, "Place 1 accusation.", accusation_value=1))
        for _ in range(8):
            self.cards.append(Card("Evidence", CardColor.RED, "Place 2 accusations.", accusation_value=2))
